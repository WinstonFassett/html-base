...
define(['ko','jquery', 'require'], function(ko, jQuery, require){
	...
	var ExternalTemplateSource = function(templateId, options) {
	    ...
	    self.template = ko.observable(
            //infuser.defaults.useLoadingTemplate ? infuser.defaults.loadingTemplate.content : undefined
        );
	    self.template.data = {};
	...
	ko.utils.extend(ExternalTemplateSource.prototype, {
	    ...
	    getTemplate: function() {
	        ...
	        //    self.loaded = true;
	        //});	        
	        var templateId = self.options.templateId;
	        var path = "" + templateId + ".html";
	        //console.log('getTemplate', path, self.options);
